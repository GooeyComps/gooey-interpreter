...
#                        self.checkVarname(expr,self.bindings)
#                        selected = False
#                        var = IntVar()
#                        if hasattr(expr, "attributes"):
#                            for item in expr.attributes:
...
#                                            count += 1
#                                        if (count == 2):
#                                            raise GooeyError("Cannot have multiple defaults.")
#
#                                    i = 0
#                                    j = 0
#                                    while(i < len(item.options.options)):
...
#                        expr.funcaction[i] = b
#
#                    if expr.funcname in self.bindings:
...
#                        print("BINDINGS THING: ", self.bindings[function].params)
#                        functionParam = self.bindings[function].params
#                        #functionInput = bindings[functionParam[0]]
#
#                        #Assuming only one parameter
#                        functionInput = self.bindings[expr.params[0]]
#
...
#                                print("HERE'S LOCALI.BINDINGS",localI.bindings)
                            else:
...
#        # return newBindings
    ...
    def checkVarname(self,exp):
        if hasattr(exp, "varname"):
            ...
            if exp.varname in self.bindings:
                message = str(exp.varname)+"already defined."
    ...
    def getObject(self,exp):
        if exp.varname in self.bindings:
            ...
            message = str(exp.varname)+"undefined."
            raise GooeyError(message)
