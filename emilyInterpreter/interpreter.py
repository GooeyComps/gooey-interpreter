...
class Binding:
    ...
    def __repr__(self):
        prettyStr = "Binding " + self.varname + " of type " + self.bType + "."
        return prettyStr
            ...
            #               FUNCTIONS
                ...
                if function in bindings:
                    ...
                    if len(expr.params)>0:
                        ...
                        print(" new bindings in interpret: ", newBindings)
#                        newB = self.runFunction(bindings,function,localBindings)
                        ...
                        newBindings = self.runFunction(bindings,function,localBindings)
                        print(" new bindings in interpret else: ", newBindings)
                        #need to add any new binding in here to regular bindings
                        for i in newBindings.keys():
                            bindings[i] = newBindings[i]
                        print("i added the new bindings", bindings)
            ...
            elif(expr.__class__.__name__ == "FuncLine" or expr.__class__.__name__ == "FuncLastLine"):
                print("It's a line!")
